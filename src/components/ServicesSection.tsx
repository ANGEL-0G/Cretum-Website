        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <div
              ...
              className="bg-primary text-primary-foreground rounded-xl h-[200px] p-8 flex flex-col items-center justify-center hover:opacity-90 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-lg"
            >
              ...
              {service.subtitle && (
                <p className="text-sm mt-3 text-primary-foreground/80 text-center max-w-[190px]">{service.subtitle}</p>
              )}
            </div>
          ))}
        </div>
